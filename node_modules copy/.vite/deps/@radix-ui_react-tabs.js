...
// node_modules/@radix-ui/react-tabs/node_modules/@radix-ui/primitive/dist/internal/is-development.true.mjs
...
function useIsHydrated() {
  const [isHydrated, setIsHydrated] = React11.useState(_isHydrated);
  React11.useEffect(() => {
    if (!_isHydrated) {
      _isHydrated = true;
      setIsHydrated(true);
...
__name11(useIsHydratedModern, "useIsHydratedModern");
...
var RovingFocusGroup = React12.forwardRef(
  ...
  __name12(function RovingFocusGroup2(props, forwardedRef) {
...
var RovingFocusGroupImpl = React12.forwardRef(__name12(function RovingFocusGroupImpl2(props, forwardedRef) {
  const {
...
var RovingFocusGroupItem = React12.forwardRef(
  // blank line to reduce diff noise
  __name12(function RovingFocusGroupItem2(props, forwardedRef) {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
      active = false,
...
__name12(getDirectionAwareKey, "getDirectionAwareKey");
...
__name12(getFocusIntent, "getFocusIntent");
...
var Tabs = React14.forwardRef(
  // blank line to reduce diff noise
  __name14(function Tabs2(props, forwardedRef) {
    const {
      __scopeTabs,
      value: valueProp,
      onValueChange,
...
var TabsList = React14.forwardRef(
  // blank line to reduce diff noise
  __name14(function TabsList2(props, forwardedRef) {
...
var TabsTrigger = React14.forwardRef(
  __name14(function TabsTrigger2(props, forwardedRef) {
...
var TabsContent = React14.forwardRef(
  __name14(function TabsContent2(props, forwardedRef) {
...
__name14(makeTriggerId, "makeTriggerId");
function makeContentId(baseId, value) {
  return `${baseId}-content-${value}`;
}
__name14(makeContentId, "makeContentId");
var Root2 = Tabs;
var List = TabsList;
